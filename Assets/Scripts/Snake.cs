...
namespace Freehill.SnakeLand
{
    ...
    public class Snake : MonoBehaviour
    {
        ...
        public SnakePart _snakePartPrefab;
        public SnakePart _snakeTailPrefab;
        ...
        public void Init(SnakesManager snakesManager)
        {
            ...
            SnakePart snakeTail = Instantiate(_snakeTailPrefab, transform.position, Quaternion.identity);
        ...
        public void Grow()
        {
            ...
            { 
                SnakePart snakePart = Instantiate(_snakePartPrefab, _snakeMovement.HeadPosition, Quaternion.identity);
